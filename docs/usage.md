...
- Если MAX сообщил о чём-то, что сервер не умеет учесть (чат прочитан на телефоне, сообщение
  удалено), он перестаёт раздавать свой вход, и команды снова входят сами — до его следующего
  переподключения.
