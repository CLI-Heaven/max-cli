...
| Что есть | max-cli | [PyMax](https://github.com/MaxApiTeam/PyMax) | [max-mcp](https://github.com/renosaza/max-mcp) | [Bot API MAX](https://dev.max.ru/docs) |
|---|:-:|:-:|:-:|:-:|
| работа от вашего имени, а не от бота | ✅ | ✅ | ✅ | — |
| готовые команды, без своей программы | ✅ | — | — | — |
| MCP-сервер для агентов | ✅ | — | ✅ | — |
| навык для Claude Code, Codex, Gemini CLI | ✅ | — | — | — |
| группы, контакты, профиль, реакции, правка, пересылка | ✅ | ✅ | — | — |
| профиль только для чтения, список разрешённых чатов, лимит в час | ✅ | — | — | — |
| подтверждение каждой отправки агентом | ✅ | — | — | — |
| своя копия переписки: поиск и чтение без интернета | ✅ | — | — | — |
| токен в системном хранилище паролей | ✅ | — | — | — |
| события в реальном времени, свои боты на аккаунте | — | ✅ | — | ✅ |
