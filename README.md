...
Ваш личный аккаунт мессенджера [MAX](https://max.ru) в терминале и в ИИ-агентах. `max` — программа для терминала и
...
Агент ничего не отправляет без вашего «да», а чтение не ставит отметку «прочитано». Как настроить
