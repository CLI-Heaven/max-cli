...
12. **`max inbox` сдвигает место, где владелец остановился.** После него следующий `max inbox`
   владельца не покажет того, что уже увидел агент. Посмотреть, не сдвигая, — `max inbox --since
   <время>`.
...
max inbox --json                               # что написали во все чаты с прошлой проверки
